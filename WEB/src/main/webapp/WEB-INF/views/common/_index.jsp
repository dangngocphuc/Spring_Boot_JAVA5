	...
	<div class="wrap-slick1">
		<div class="slick1">
			<div class="item-slick1"
				style="background-image: url(https://bizweb.dktcdn.net/100/339/085/themes/699262/assets/slider_1_image.png?1617599688437);">
			...
			<div class="item-slick1"
				style="background-image: url(https://bizweb.dktcdn.net/100/339/085/themes/699262/assets/index_banner_large_image___2.jpg?1617599688437);">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						<div class="layer-slick1 animated visible-false"
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				<form action="">
					...
					<div class="block1 wrap-pic-w">
						<img
							src="${pageContext.request.contextPath}/resource/site/images/banner-01.jpg"
							alt="IMG-BANNER"> <a href="/product/find/${WOMAN}"
			...
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				...
				<div class="block1 wrap-pic-w">
					<img
						src="${pageContext.request.contextPath}/resource/site/images/banner-02.jpg"
			...
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				...
				<div class="block1 wrap-pic-w">
					<img
						src="${pageContext.request.contextPath}/resource/site/images/banner-03.jpg"
						alt="IMG-BANNER"> <a href="product.html"
						class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
